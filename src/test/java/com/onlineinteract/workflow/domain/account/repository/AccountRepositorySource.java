...
import com.onlineinteract.workflow.dbclient.DbClientSource;
...
@Repository
public class AccountRepositorySource {

	@Autowired
	DbClientSource dbClientSource;

	public AccountRepositorySource() {
	}

	public void createAccount(AccountV3 accountV3) {
		MongoDatabase database = dbClientSource.getMongoClient().getDatabase(DbClient.DATABASE);
